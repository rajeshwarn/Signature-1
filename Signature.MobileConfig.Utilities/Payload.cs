...
namespace MobileConfigUtility
{
    ...
    {
        [KeyAttributes("PayloadType", PlistType.String, Presence.Optional)]
        public string PayloadType { get; set; }
        
        [KeyAttributes("PayloadVersion", PlistType.Integer, "1", Presence.Optional)]
        public int PayloadVersion { get; set; }
        
        [KeyAttributes("PayloadIdentifier", PlistType.String, Presence.Optional)]
        public string PayloadIdentifier { get; set; }
        
        [KeyAttributes("PayloadUUID", PlistType.String, Presence.Optional)]
        public string PayloadUUID { get; set; }
        
        [KeyAttributes("PayloadDisplayName", PlistType.String, Presence.Optional)]
